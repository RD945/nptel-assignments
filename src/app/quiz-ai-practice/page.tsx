...
import {
  aiPracticeQuestions,
  PracticeQuestion,
} from "@/data/ai-practice-questions";
...
export default function QuizAiPractice() {
  const [state, setState] = useState<QuizState | null>(null);

  useEffect(() => {
    const shuffled = shuffleArray(aiPracticeQuestions);
    setState({
    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.results}>
          <h2 className={styles.resultsTitle}>AI Practice Complete!</h2>
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.counter}>
          AI Practice {state.currentIndex + 1} / {totalQuestions}
        </div>
        <div className={styles.week}>Generated Set</div>
      </div>
